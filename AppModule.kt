...
import com.propdf.editor.data.repository.PdfRepository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideAiSummaryManager(): AiSummaryManager = AiSummaryManager()
    ...
    ): PdfRepository = PdfRepository(context, fileHelper)
    ...
    @Provides
    @Singleton
    fun provideFileHelper(): FileHelper = FileHelper
}

...
class ViewerActivity : AppCompatActivity() {
    ...
    private fun showTextDialog() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Add") { _, _ ->
                ...
                if (text.isNotBlank()) {
                    currentAnnotatedView?.canvasView?.addTextAnnotation(
                        text, 100f, 100f
                    )
                }
            }
    ...
    private fun saveAnnotations() {
        currentAnnotatedView?.let { view ->
            if (view.canvasView.hasAnnotations()) {
                ...
                // Save bitmap to file or merge with PDF
    ...
    private fun printPdf() {
        ...
        val jobName = "ProPDF Document"
        printManager.print(jobName, android.print.PrintDocumentAdapter(), null)
    }

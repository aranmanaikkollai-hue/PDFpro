    ...
    suspend fun addTextWatermark(
        ...
        runCatching {
            ...
            for (i in 0 until pages.count) {
                ...
                // FIX: Use float value 0.5f for gray instead of PDDeviceGray.INSTANCE
                stream.setNonStrokingColor(0.5f)
                stream.beginText()
                // FIX: Math.toRadians returns Double, pass as Double

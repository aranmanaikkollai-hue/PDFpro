...
class ViewerActivity : AppCompatActivity() {
    ...
    // FIXED: Actually saves annotations to a file
    ...
    private fun setupRecyclerView() {
        adapter = PdfPageAdapter(this, pdfUri) { pageView: AnnotatedPageView ->
            currentAnnotatedView = pageView
            // Set up save callback for each page
            pageView.onSaveClicked = { bitmap ->
                // Handle per-page save if needed
            }
        }
